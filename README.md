...
Not only am I (still) not a pro, nor do I have a degree in computer science, but also this is a pretty challenging time for me. As of Day 25, I managed to solve all the problems on the same day with two exceptions - Days 21 and Day 24 part 2. Their difficulty, as well as time constraints, caused me to abandon both for now. I will be back!
